...
class DevelopmentConfig(Config):
    ...
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = "postgresql://postgres:ntrongkhanh@localhost:5432/fresh_fruit"
...
class MySqlConfig(Config):
    ...
    # FLASK_ENV = 'development'
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = "mysql://ntrongkhanh:ntrongkhanh@127.0.0.1:3306/fresh_fruit"
    SQLALCHEMY_TRACK_MODIFICATIONS = True
    SERVER_ADDRESS = 'http://127.0.0.1:5000'
